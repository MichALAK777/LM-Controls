...
namespace LMControls.LmControls
{
    ...
    public partial class LmTabControl : TabControl, ILmControl
    {
        ...
        public LmTabControl()
        {
            ...
            this.Selecting += LmTabControl_Selecting;
        ...
        [Editor("LMControls.LmControls.Design.LmTabPageCollectionEditor", typeof(UITypeEditor))]
        ...
        {
            using (Brush bgBrush = new SolidBrush(LmPaint.BackColor.TabControl.Normal(Theme)))
            {
        ...
        private Size MeasureText(string text)
        {
            ...
            using (Graphics g = CreateGraphics())
            {
                ...
                preferredSize = TextRenderer.MeasureText(g, text, LmFonts.TabControl(lmLabelSize, lmLabelWeight),
                                                         proposedSize,
                                                         LmPaint.GetTextFormatFlags(TextAlign) |
        ...
        private void DrawTabSelected(int index, Graphics graphics)
        {
            using (Brush selectionBrush = new SolidBrush(LmPaint.BackColor.TabControl.Selected(Theme)))
            {
                ...
                TextRenderer.DrawText(graphics, tabPage.Text, LmFonts.TabControl(lmLabelSize, lmLabelWeight),
                                  newSelectedTabRect, foreColorSelected, backColorSelected, LmPaint.GetTextFormatFlags(TextAlign));
            }
        }
        ...
        private void DrawTab(int index, Graphics graphics)
        {
            ...
            TextRenderer.DrawText(graphics, tabPage.Text, LmFonts.TabControl(lmLabelSize, lmLabelWeight),
                                  tabRect, foreColor, Color.Transparent, LmPaint.GetTextFormatFlags(TextAlign));
        }

        [SecuritySafeCritical]
        private void DrawUpDown(Graphics graphics)
        {
            Color backColor = Parent != null ? Parent.BackColor : LmPaint.BackColor.Form(Theme);
            ...
            using (Brush b = new SolidBrush(LmPaint.BorderColor.TabControl.Normal(Theme)))
            {
        ...
        void LmTabControl_Selecting(object sender, TabControlCancelEventArgs e)
        {
    ...
    #region LmTabPageCollection

    [ToolboxItem(false)]
    [Editor("LMControls.LmControls.Design.LmTabPageCollectionEditor", typeof(UITypeEditor))]
    public class LmTabPageCollection : TabControl.TabPageCollection
    {
        public LmTabPageCollection(LmTabControl owner)
            : base(owner)
        { }
    }
