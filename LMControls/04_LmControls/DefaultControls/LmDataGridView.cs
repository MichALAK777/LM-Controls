...
{
    public class LmDataGridView : DataGridView, ILmControl
    {
        #region Construtor
        ...
        public LmDataGridView()
        {
            ...
            this.MouseDown += LmDataGridView_MouseDown;
        }
        ...
        private void LmDataGridView_MouseDown(object sender, MouseEventArgs e)
        {
