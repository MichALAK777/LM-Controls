...
namespace LMControls.Metodos
{
    public class Email
    {
        public static string ServidorSMTP_Envio { get; set; } = "smtp.gmail.com";
        public static int PortaSMTP_Envio { get; set; } = 587;
        public static string UsuarioEmail_Envio { get; set; } = "corbie.noreply@gmail.com";
        public static string SenhaEmail_Envio { get; set; } = "@@D3s3nv2022##";
